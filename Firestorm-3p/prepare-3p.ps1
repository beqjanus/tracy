...
Move-Item $tracy_folder_root\LICENSE .\LICENSES\Tracy.txt
...
Move-Item $tracy_folder_root\*.h .\include\tracy
Move-Item $tracy_folder_root\common\*.hpp .\include\tracy\common
Move-Item $tracy_folder_root\common\*.h .\include\tracy\common
Move-Item $tracy_folder_root\common\*.cpp .\include\tracy\common
